 ...
 * @endcode
 */
$settings['hash_salt'] = 't26MZR8kg_N5zJRi2uVGIkNXslk3lGwd3WW9CXz_spjLK6D3Subz4VYNSwOqXy1pPcamG-k9OQ';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_hpc_massforms8_mass_gov_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_hpc_massforms8_mass_gov_dd.inc';
}
// </DDSETTINGS>
